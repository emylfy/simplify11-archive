...
echo.
echo  =============================================================
echo  =    script forked from various 'win tweakers' of github    =
echo  =============================================================
...
if defined svcHostThreshold (
    reg add "HKLM\SYSTEM\ControlSet001\Control" /v "SvcHostSplitThresholdInKB" /t REG_DWORD /d !svcHostThreshold! /f
...
:4
cls
start https://github.com/emylfy/simplify11
goto main